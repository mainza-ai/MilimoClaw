...
async function getHealthData(squadId) {
    const healthPath = (0, path_1.join)((0, os_1.homedir)(), ".milimo", "health", "health.json");
    if (!(0, fs_1.existsSync)(healthPath)) {
        return null;
    }
    try {
...
`;
    return new Promise((resolve, reject) => {
        const proc = (0, child_process_1.spawn)("python3", ["-c", script], {
            cwd: blueprintDir,
        });
        proc.on("close", (code) => {
            if (code === 0) {
...
exports.healthCommand = new commander_1.Command("health")
    ...
    const blueprintDir = process.env.MILIMO_BLUEPRINT_DIR || (0, path_1.join)((0, os_1.homedir)(), ".milimo", "blueprints", squadId);
    if (options.collect) {
        try {
