  ...
  return [
    {
      ...
      description: "One-person operation with all claws active",
      category: "solo",
      path: "",
      squadSize: 1,
    ...
    },
    {
      ...
      description: "Content-first squad for agencies and creators",
      category: "agency",
      path: "",
      squadSize: 3,
    ...
    },
    {
      ...
      description: "Visual creative squad for design studios",
      category: "studio",
      path: "",
      squadSize: 4,
      clawsActive: ["content", "build", "ops", "analytics"] as ClawRole[],
      solo: false,
    },
    {
      id: "tech-consultancy",
      name: "tech-consultancy",
      displayName: "Tech Consultancy",
      description: "Full-stack tech squad with build focus",
