...
import { ApprovalEngine, type PendingMessage } from "../warroom/approval.js";
import type { MilimoConfig, PluginLogger } from "../index.js";
import { loadOnboardConfig } from "../onboard/config.js";

export async function cliWarRoom(opts: { operator: string; logger: PluginLogger; pluginConfig: MilimoConfig; list?: boolean }) {
