...
const mockBridge = jest.requireMock("../lib/python-bridge");
...
describe("DigestScheduler", () => {
    ...
    describe("renderBrief()", () => {
        ...
        it("shows evolution updates on Sunday", () => {
            ...
            expect(lines.some(l => l.includes("Evolution Updates") || l.includes("auto_replier"))).toBe(true);
        });
    });
