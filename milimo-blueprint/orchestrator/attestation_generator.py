...
from .provenance_signer import ProvenanceSigner, Attestation
...
class VerificationInfo:
    ...
    method: str = (
        "self_attested"  # backtest, live_measurement, auditor_verified, self_attested
    )
    data_integrity: str = ""
...
class AttestationGenerator:
    ...
    def generate(
        ...
        if (
            metrics.confidence_lower is not None
            and metrics.confidence_upper is not None
        ):
                ...
                attestations.append(
                    {
                        ...
                        "improvement": data.get("metrics", {}).get(
