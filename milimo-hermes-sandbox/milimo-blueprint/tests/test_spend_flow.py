...
class TestSpendFlowRobustness:
    ...
    def test_json_array_parsing_and_status_updates(self, spend_handler: SpendApprovalHandler):
    ...
    def test_state_recovery_across_restarts(self, operational_log: FinanceOperationalLog, log_dir: Path):
    ...
    def test_warroom_bridge_fallback_recovery(self, spend_handler: SpendApprovalHandler, log_dir: Path):
        ...
        bridge = SpendWarRoomBridge(spend_handler=spend_handler, solo_warroom=solo_warroom)
        ...
        hold_action = next((a for a in pending_actions if a.action_type == "spend_hold"), None)
