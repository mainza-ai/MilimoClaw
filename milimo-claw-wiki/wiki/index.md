...
| 2026-06-30 | Nous Portal docs: `hermes setup --portal` for managed tool gateways, network policy prerequisite for portal.nousresearch.com | hermes-profile.md, README.md, index.md |
