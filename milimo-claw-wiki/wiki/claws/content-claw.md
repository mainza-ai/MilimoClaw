...
| `/sandbox/.openclaw/milimo/claws/content/brand/` | Brand assets, style guides | Read-write |
...
- Read `/sandbox/.openclaw/milimo/claws/ops`, `/sandbox/.openclaw/milimo/claws/finance`, or `/sandbox/.openclaw/milimo/claws/build`
