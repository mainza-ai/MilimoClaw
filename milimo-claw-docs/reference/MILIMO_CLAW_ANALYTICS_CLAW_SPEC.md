...
- `/sandbox/analytics/reports/` (owns and writes this)
...
9. Write complete report to `/sandbox/analytics/reports/weekly-intelligence.json`
10. Archive previous report to `/sandbox/analytics/reports/weekly-intelligence-archive/{date}.json`
