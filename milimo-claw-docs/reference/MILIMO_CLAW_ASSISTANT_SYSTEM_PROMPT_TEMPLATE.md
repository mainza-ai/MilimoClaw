...
>
> This spec uses `/sandbox/.openclaw/milimo/` as the canonical base directory. The older `/sandbox/.openclaw-data/milimo/` path is deprecated.
>
> **Key paths:**
>
...
```
bridge: read_file("/sandbox/.openclaw/milimo/claws/analytics/reports/weekly-intelligence.json")
```
